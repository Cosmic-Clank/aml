		...
		<main className={`flex flex-col items-center justify-center bg-zinc-100 overflow-hidden ${font.className}`}>
			...
			<SectionContainer>
				...
				<div>
					...
					This website is operated by AL MADINA LANDSCAPE. Throughout the site, the terms “we”, “us” and “our” refer to AL MADINA LANDSCAPE. AL MADINA LANDSCAPE offers this website, including all information, tools, and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies, and notices stated here. <br />
					<br />
